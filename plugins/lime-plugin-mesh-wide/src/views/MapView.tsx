...
/**
 * Map view component - Geographic visualization using Leaflet
 *
 * This is the original map-based view moved from containers/Map.tsx
 * Shows nodes and links on an interactive map with OSM tiles.
 */
...
/**
 * Complete map view with floating alert and bottom sheet
 */
